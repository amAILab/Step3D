...
## Дополнительный conversion / WCAG / responsive pass
- Усилены сценарии: сломалась деталь, прототип, реверс-инжиниринг, малая серия, мастер-класс, B2B.
- На главной добавлена карта маршрутов и честный блок доверия/рисков.
- В квиз добавлен B2B-сценарий; в быстрые шаблоны заявки добавлен B2B/NDA.
- На страницах услуг добавлен спокойный повтор CTA перед финальным блоком.
- App/Viewer/Account получили единые объяснения: что делать без файла, как работает номер S3D, что важно для B2B.
- Усилены labels в микро-калькуляторе, touch targets, таблицы, mobile layouts и ширины 320–1920px через финальный CSS-слой.
