...
checks={
 ...
 'index.html':['Покажите деталь','home-focus-strip','Рассчитать по фото / STL'],
 'app/index.html':['Заявка за минуту','required-later','Получить номер S3D','Дослать файлы в Telegram'],
 'viewer/index.html':['Есть STL?','Что нужно для заявки','Заявка по фото без Viewer'],
 'account/index.html':['Карточка заявки','preview-карточка','финальное подтверждение'],
